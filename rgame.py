...
# "Start" screen
drawText('Press any key to start the car race.', font, windowSurface, (WINDOWWIDTH / 3) - 30, (WINDOWHEIGHT / 3))
drawText('And Enjoy', font, windowSurface, (WINDOWWIDTH / 3), (WINDOWHEIGHT / 3) + 35)
...
while (count > 0):
    ...
    while True:  # the game loop
        ...
        drawText('--x-x-x-x-x-x-x--', font, windowSurface, 128, 0)
        drawText('Score: %s' % (score), font, windowSurface, 128, 20)
        drawText('Top Score: %s' % (topScore), font, windowSurface, 128, 40)
        drawText('Rest Life: %s' % (count), font, windowSurface, 128, 60)
        drawText('--x-x-x-x-x-x-x--', font, windowSurface, 128, 80)
